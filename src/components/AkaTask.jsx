...
const AkaTask = () => {
    return (
        <div style={{ padding: '20px', background: '#FDFBF9'}}>
            ...
            <button onClick={() => {window.open('https://apps.apple.com/az/app/akatask/id6566193664?platform=iphone', '_blank' )}} style={{paddingTop: '1rem', paddingBottom: '1rem', paddingRight: '3rem', paddingLeft: '3rem', fontFamily: 'Montserrat', backgroundColor: '#CA2500', border: 'none', borderRadius: '2rem', boxShadow: '0.15rem 0.15rem 0.15rem lightgray'}}>Try for free</button>
